...
// it.
void ImageWriter::writeToPNGFile(
...
void ImageWriter::writeToJPGFile(
    const std::string& filename /* = "pic.jpg" */) {
...
void ImageWriter::writeToPPMFile(
    const std::string& filename /* = "pic.ppm" */) {
    /**
